# YouTube packaging — Alberto's breakfast burrito

Cut: 2:46 (166.5s), 1920x1080, 24 fps, -14 LUFS. File:
`AlbertosBreakfastBurrito_1080p.mp4`
...
Paste as-is. YouTube requires the first to be 0:00 and each chapter to run at
least 10 seconds, which these do.
...
breakfast burrito, albertos, albertos mexican food, escondido, san diego food,
mexican food review, food review, taqueria, guacamole, drive thru, 24 hour
mexican food, mr taco shop, best breakfast burrito san diego, tapatio

## Before you upload

- **Three censor bleeps** are baked in (1:28, 1:56, 2:15). The audio is bleeped
  mid-word — front and tail audible — as a bit, and the burned captions are
  masked to match (`S***`), so picture and sound agree. This is ad-friendly
  treatment for profanity in a food context.
- **The Taco Bell segment** shows a real KTLA report on a real, CDC-confirmed
  cyclospora outbreak traced to Taylor Farms de Mexico lettuce served at Taco
  Bell (1,900+ cases, nine states, July 2026). It is commentary on a genuine
  news story, not an invented graphic — which is what keeps the joke
  defensible.
- **Music** is your own parody track, "Pásame la Salsa", entering at 1:35 of
  the source and sitting 16 dB under dialogue. Since it is your composition
  there is no third-party claim exposure.
- **Captions** are burned in. Consider also uploading `edit/master.srt` as a
  subtitle track so the text is searchable and accessible.
